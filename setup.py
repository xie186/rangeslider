...
filename = path.join(here, 'kivy_garden', 'rangeslider', '_version.py')
# change this                              ^^^^^^
locals = {}
...
URL = 'https://github.com/kivy-garden/rangeslider'

setup(
    name='kivy_garden.rangeslider',
    version=__version__,
    description='A kivy garden rangeslider demo.',
